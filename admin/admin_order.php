        ...
        <div class="box-container">
            <?php
                ...
                $select_order = $conn->prepare("
                    SELECT 
                        ...
                        payment_status 
                    FROM `orders` 
                    WHERE seller_id =? AND status = 'canceled'
                    GROUP BY id
                ");
            ...
            <div class="box">
                <div class="status" style="color: <?php if ($fetch_order['status'] == 'in progress') {echo "limegreen";}else{echo "red";}?>">
                    <?= $fetch_order['status'] == 'in progress' ? 'đang xử lý' : ($fetch_order['status'] == 'canceled' ? 'đã hủy' : $fetch_order['status']); ?></div> 
                ...
                <div class="detail">
                    ...
                    <!-- <p>Tên sản phẩm: <span><?= $fetch_order['product_names']; ?></span></p> Thêm tên sản phẩm -->
                </div>
