...
<div class="sidebar">
    ...
    <div class="navbar">
        <ul>
            ...
            <li><a href="employee_profile.php"><i class="bx bxs-user"></i>hồ sơ</a></li>
            <li><a href="add_warehouse_employee.php"><i class='bx bxs-home-alt-2'></i>nhập hàng</a></li>
            <li><a href="manage_products_employee.php"><i class='bx bx-list-ol'></i>danh sách nhập hàng</a></li>
            <li><a href="chitiethangnv.php"><i class='bx bx-list-ol'></i>danh sách chi tiết</a></li>
            <li><a href="../components/admin_logout.php" onclick="return confirm('logout from this website');"><i
                        class="bx bxs-log-out"></i>đăng xuất</a></li>
        </ul>
    </div>
